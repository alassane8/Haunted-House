...
const graveGeometry = new THREE.BoxGeometry(.6, 0.8, .2)
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#add8e6', 6, 3)
scene.add(ghost1)
const ghost2 = new THREE.PointLight('#add8e6', 6, 3)
scene.add(ghost2)
const ghost3 = new THREE.PointLight('#add8e6', 6, 3)
scene.add(ghost3)
/**
 * Sizes
 */
